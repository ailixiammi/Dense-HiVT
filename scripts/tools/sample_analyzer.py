...
# 加载样本
sample = torch.load('/root/vc/data/train/processed_dense/144519.pt')
...
#print(f"agent_history_positions:{agent_history_positions[0]}")

agent_history_positions_mask = sample['agent_history_positions_mask']   # shape [64, 20]
#print("agent_history_positions_mask:{agent_history_positions_mask[0]}")
